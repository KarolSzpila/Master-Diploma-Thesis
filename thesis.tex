...
\chapter{Performance evaluation}
	...
	\section{Simulations}
		...
		\subsection*{Moving Average Filter}
			...
			In this scenario Moving Average Filter for DC offset removal is tested.
			First test considers single ton signal with following test parameters:
			\begin{itemize}
				\item amplitude - 1,
				\item frequency - 1000Hz,
				\item DC offset in Q branch - 0.1
