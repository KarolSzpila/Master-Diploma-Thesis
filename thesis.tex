	...
	\subsection*{Single Tone Signal}
		...
		\subsubsection*{Scenario 2:}
			...
			\begin{figure}[H]
				...
				\begin{tabular}[c]{@{}c@{}}IQ phase\\ shift {[}deg{]}\end{tabular} & -87          & -89.9437                                                        & -90.0583                                                  \\ \hline
			...
			\begin{figure}[H]
				...
				\hline
																				   & Input signal & \begin{tabular}[c]{@{}c@{}}Moving Average\\ Filter\end{tabular} & \begin{tabular}[c]{@{}c@{}}Gaussian\\ Filter\end{tabular} \\ \hline
				\begin{tabular}[c]{@{}c@{}}IQ phase\\ shift {[}deg{]}\end{tabular} & -81          & -87.2434                                                        & -86.1984                                                  \\ \hline
			...
			\begin{figure}[H]
				...
				\hline
																				   & Input signal & \begin{tabular}[c]{@{}c@{}}Moving Average\\ Filter\end{tabular} & \begin{tabular}[c]{@{}c@{}}Gaussian\\ Filter\end{tabular} \\ \hline
				\begin{tabular}[c]{@{}c@{}}IQ phase\\ shift {[}deg{]}\end{tabular} & -72          & -79.8820                                                        & -80.2054                                                  \\ \hline
