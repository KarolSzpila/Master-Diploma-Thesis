...
\chapter{Theoretical background}
	...
	\section{Theoretical operation of mixer}
		...
		signal multiplication. Such process is used virtually in every radio device.
		...
		\begin{figure}[!htb]
    		\centering
   			\includegraphics[width=\textwidth]{diag/downmx.png}
    		\caption{\textit{Schematic down-converter}}
		\end{figure}
		
		\newpage
		\begin{figure}[!htb]
    		\centering
   			\includegraphics[width=\textwidth]{diag/upmx.png}
    		\caption{\textit{Schematic of up-converter}}
