	...
	\subsection*{Single Tone Signal}
		...
		\subsubsection*{Scenario 2:}
			...
			\begin{figure}[H]
				...
				\begin{tabular}{|c|c|c|c|}
				\hline
																				   & Input signal & \begin{tabular}[c]{@{}c@{}}Moving Average\\ Filter\end{tabular} & \begin{tabular}[c]{@{}c@{}}Gaussian\\ Filter\end{tabular} \\ \hline
				\begin{tabular}[c]{@{}c@{}}IQ phase\\ shift {[}deg{]}\end{tabular} & -87          & -89.94                                                        & -90.06                                                  \\ \hline
				Image {[}dB{]}                                                     & -34.95       & Noise level                                                     & Noise level                                               \\ \hline
				\end{tabular}
				\end{table}
			...
			\begin{figure}[H]
    			\centering
   				\includegraphics[width=0.95\textwidth]{plots/single_nf2.png}
   		 		\caption{\textit{Comparison of spectrum for IQ mismatch compensation algorithms 
   		 		for signle tone signal with noise.}}
   		 	\end{figure}	
   		 	...
   		 	\begin{figure}[H]
    			\centering
   				\includegraphics[width=0.95\textwidth]{plots/single_nc2.png}
   		 		\caption{\textit{Comparison of constellations for IQ mismatch compensation algorithms 
   		 		for signle tone signal with noise.}}
   		 	\end{figure}
   		 		\begin{table}[H]
				...
				\hline
																				   & Input signal & \begin{tabular}[c]{@{}c@{}}Moving Average\\ Filter\end{tabular} & \begin{tabular}[c]{@{}c@{}}Gaussian\\ Filter\end{tabular} \\ \hline
				\begin{tabular}[c]{@{}c@{}}IQ phase\\ shift {[}deg{]}\end{tabular} & -81          & -87.24                                                        & -86.19                                                  \\ \hline
				Image {[}dB{]}                                                     & -22.68       & -32.58                                                          & -36.81                                                    \\ \hline
				\end{tabular}
				\end{table}
			...
			\begin{figure}[H]
    			\centering
   				\includegraphics[width=0.93\textwidth]{plots/single_nf3.png}
   		 		\caption{\textit{Comparison of spectrum for IQ mismatch compensation algorithms 
   		 		for signle tone signal with noise.}}
   		 	\end{figure}	
   		 	\begin{figure}[H]
    			\centering
   				\includegraphics[width=0.93\textwidth]{plots/single_nc3.png}
   		 		\caption{\textit{Comparison of constellations for IQ mismatch compensation algorithms 
   		 		for signle tone signal with noise.}}
   		 	\end{figure}
				...
				\hline
																				   & Input signal & \begin{tabular}[c]{@{}c@{}}Moving Average\\ Filter\end{tabular} & \begin{tabular}[c]{@{}c@{}}Gaussian\\ Filter\end{tabular} \\ \hline
				\begin{tabular}[c]{@{}c@{}}IQ phase\\ shift {[}deg{]}\end{tabular} & -72          & -79.88                                                        & -80.21                                                  \\ \hline
				Image {[}dB{]}                                                     & -16.06       & -24.39                                                          & -27.44                                                    \\ \hline
				\end{tabular}
				\end{table}
   	\newpage
   	\subsection*{Multi tone}
		...
		\subsubsection*{Scenario 2: }
			...
			\begin{table}[H]
				...
				\hline
																				   & \multicolumn{2}{c|}{Input signal} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}Moving Average\\ Filter\end{tabular}} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}Gaussian\\ Filter\end{tabular}} \\ \hline
				\begin{tabular}[c]{@{}c@{}}IQ phase\\ shift {[}deg{]}\end{tabular} & \multicolumn{2}{c|}{-87}          & \multicolumn{2}{c|}{-90.0380}                                                        & \multicolumn{2}{c|}{-90.0004}                                                  \\ \hline
				\multirow{2}{*}{Image {[}db{]}}                                    & -1kHz           & -0.5kHz         & -1kHz                                     & -0.5kHz                                  & -1kHz                                  & -0.5kHz                               \\ \cline{2-7} 
   		...
   		\subsubsection*{Scenario 3: }
			...
			\end{itemize}
				...
				\hline
																				   & \multicolumn{2}{c|}{Input signal} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}Moving Average\\ Filter\end{tabular}} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}Gaussian\\ Filter\end{tabular}} \\ \hline
				\begin{tabular}[c]{@{}c@{}}IQ phase\\ shift {[}deg{]}\end{tabular} & \multicolumn{2}{c|}{-81}          & \multicolumn{2}{c|}{-88.3068}                                                        & \multicolumn{2}{c|}{-88.2219}                                                  \\ \hline
				\multirow{2}{*}{Image {[}db{]}}                                    & -1kHz           & -0.5kHz         & -1kHz                                     & -0.5kHz                                  & -1kHz                                  & -0.5kHz                               \\ \cline{2-7} 
   		...
   		\subsubsection*{Scenario 4: }
			...
			\end{itemize}
				...
				\hline
																				   & \multicolumn{2}{c|}{Input signal} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}Moving Average\\ Filter\end{tabular}} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}Gaussian\\ Filter\end{tabular}} \\ \hline
				\begin{tabular}[c]{@{}c@{}}IQ phase\\ shift {[}deg{]}\end{tabular} & \multicolumn{2}{c|}{-72}          & \multicolumn{2}{c|}{-81.5392}                                                        & \multicolumn{2}{c|}{-82.0654}                                                  \\ \hline
				\multirow{2}{*}{Image {[}db{]}}                                    & -1kHz           & -0.5kHz         & -1kHz                                    & -0.5kHz                                   & -1kHz                                 & -0.5kHz                                \\ \cline{2-7} 
...
\begin{table}[H]
\caption{Comparison of DC offset removal algorithms.}
\centering
\begin{tabular}{|c|c|c|c|}
\hline
                                                                 & Input Signal & Moving Average Filter & Gaussian Filter \\ \hline
\begin{tabular}[c]{@{}c@{}}DC \\ component {[}dB{]}\end{tabular} & -32.77       & -75.56                & -114.23         \\ \hline
\end{tabular}
\end{table}
		...
		\begin{figure}[!htb]
   		...
   		\begin{table}[H]
\centering
\caption{IQ mismatch correction algorithm results for single tone signal.}
\begin{tabular}{|c|c|c|c|}
\hline
                                                                   & Input Signal & Moving Average Filter & Gaussian Filter \\ \hline
\begin{tabular}[c]{@{}c@{}}IQ phase\\ shift {[}deg{]}\end{tabular} & 86.31        & 89.21                 & 90.01           \\ \hline
Image {[}dB{]}                                                     & -51.09       & -78.42                & -81.96          \\ \hline
\begin{tabular}[c]{@{}c@{}}DC \\ component {[}dB{]}\end{tabular}   & -28.58       & -87.35                & -116.56         \\ \hline
\end{tabular}
\end{table}
		
		In case of single tone signal IQ mismatch correction worked very well. Suppression of DC component was
		better for Gaussian Filter. Image was attenuated for Moving Average Filter almost 1.588 and for Gausian
		Filter 1.604 times. Phase compensation efficiency was satisfactory and mismatch was 0.79 in case of
		Moving Average and 0.01 in case of Gaussian Filter. 
...
\begin{tabular}[c]{@{}c@{}}DC \\ component {[}dB{]}\end{tabular}   & \multicolumn{2}{c|}{-28.15}       & \multicolumn{2}{c|}{-79.88}                                                          & \multicolumn{2}{c|}{-74.12}                                                    \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}c@{}}DC \\ component {[}dB{]}\end{tabular}   & \multicolumn{2}{c|}{-29.01}       & \multicolumn{2}{c|}{-71.57}                                                          & \multicolumn{2}{c|}{-70.05}                                                    \\ \hline
\end{tabular}
\end{table}	
...
\end{table}
		...
		\begin{figure}[H]
   		 	...
   		 	\end{figure}
   		 	   		...
   		 	   		\begin{table}[H]
\centering
\caption{AD9363 built in IQ mismatch correction algorithm results for single tone signal.}
\begin{tabular}{|c|c|c|}
\hline
                                                                   & Input Signal & Corrected signal  \\ \hline
\begin{tabular}[c]{@{}c@{}}IQ phase\\ shift {[}deg{]}\end{tabular} & 86.87        & 90.05 \\ \hline
Image {[}dB{]}                                                     & -43.56       & -91.63                        \\ \hline
\begin{tabular}[c]{@{}c@{}}DC \\ component {[}dB{]}\end{tabular}   & -41.23       & -74.21                  \\ \hline
\end{tabular}
\end{table}
   	\subsection*{Multiton Signal}
   		In this case built in IQ mismatch compensation and DC offset removal algorithms are
...
\hline
                                                                   & \multicolumn{2}{c|}{Input Signal} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}Moving Average\\ Filter\end{tabular}}  \\ \hline
...
\begin{tabular}[c]{@{}c@{}}DC \\ component {[}dB{]}\end{tabular}   & \multicolumn{2}{c|}{30.05}       & \multicolumn{2}{c|}{-87.12}                                                         \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}c@{}}DC \\ component {[}dB{]}\end{tabular}   & \multicolumn{2}{c|}{-31.05}       & \multicolumn{2}{c|}{-85.31}                                                         \\ \hline
\end{tabular}
\end{table}
